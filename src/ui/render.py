...
from src.ui.theme import CSS as _CSS  # noqa: E402
from src.ui.theme import ICONS as _ICONS  # noqa: E402
...
<div class="note flat">
  ...
  <ul>
    ...
    <li>不提供 Phase 3 placement gate。該閘門只被正式評估過一次
      （Phase 3C gen09），且方向是負的：Core Success@4 −5.0pp、
      95% 區間 [−9.4, −0.6]。</li>
